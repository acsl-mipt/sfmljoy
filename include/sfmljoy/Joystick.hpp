...
#ifndef SFMLJOY_JOYSTICK_HPP
#define SFMLJOY_JOYSTICK_HPP
...
#endif // SFMLJOY_JOYSTICK_HPP


////////////////////////////////////////////////////////////
/// \class sfmljoy::Joystick
/// \ingroup window
///
/// sfmljoy::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, sfmljoy::Joystick can retrieve the
...
///
/// SFML supports:
/// \li 8 joysticks (sfmljoy::Joystick::Count)
/// \li 32 buttons per joystick (sfmljoy::Joystick::ButtonCount)
/// \li 8 axes per joystick (sfmljoy::Joystick::AxisCount)
///
...
/// you must call sfmljoy::Joystick::update explicitly.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = sfmljoy::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = sfmljoy::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = sfmljoy::Joystick::hasAxis(0, sfmljoy::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = sfmljoy::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = sfmljoy::Joystick::getAxisPosition(0, sfmljoy::Joystick::Y);
/// \endcode
///
/// \see sfmljoy::Keyboard, sfmljoy::Mouse
///
////////////////////////////////////////////////////////////
