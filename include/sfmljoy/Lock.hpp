...
#ifndef SFMLJOY_LOCK_HPP
#define SFMLJOY_LOCK_HPP

////////////////////////////////////////////////////////////
// Headers
////////////////////////////////////////////////////////////
#include <sfmljoy/Config.hpp>
#include <sfmljoy/NonCopyable.hpp>
...
public:
    ...
    ///
    /// The mutex passed to sfmljoy::Lock is automatically locked.
    ///
    ...
    /// \brief Destructor
    ///
    /// The destructor of sfmljoy::Lock automatically unlocks its mutex.
    ///
    ////////////////////////////////////////////////////////////
    ~Lock();
...
/// \ingroup system
///
/// sfmljoy::Lock is a RAII wrapper for sfmljoy::Mutex. By unlocking
...
/// function.
///
/// For maximum robustness, sfmljoy::Lock should always be used
...
/// void function()
/// {
///     sfmljoy::Lock lock(mutex); // mutex is now locked
///
