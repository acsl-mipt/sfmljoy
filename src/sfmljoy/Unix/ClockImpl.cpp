...
// Headers
////////////////////////////////////////////////////////////
#include <sfmljoy/Unix/ClockImpl.hpp>
#if defined(SFMLJOY_SYSTEM_MACOS) || defined(SFMLJOY_SYSTEM_IOS)
...
Time ClockImpl::getCurrentTime()
{
    ...
    return sfmljoy::microseconds(nanoseconds / 1000);
    ...
    return sfmljoy::microseconds(static_cast<Uint64>(time.tv_sec) * 1000000 + time.tv_nsec / 1000);
