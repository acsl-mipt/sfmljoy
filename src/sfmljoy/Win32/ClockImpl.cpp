...
// Headers
////////////////////////////////////////////////////////////
#include <sfmljoy/Win32/ClockImpl.hpp>
#include <sfmljoy/Mutex.hpp>
#include <sfmljoy/Lock.hpp>
#include <windows.h>
...
Time ClockImpl::getCurrentTime()
{
    ...
    if (oldWindows)
    {
        static sfmljoy::Mutex oldWindowsMutex;
    ...
    return sfmljoy::microseconds(1000000 * time.QuadPart / frequency.QuadPart);
}
