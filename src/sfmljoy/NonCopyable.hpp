...
#ifndef SFMLJOY_NONCOPYABLE_HPP
#define SFMLJOY_NONCOPYABLE_HPP
...
protected:
    ...
    /// call delete on a pointer of sfmljoy::NonCopyable, thus
...
#endif // SFMLJOY_NONCOPYABLE_HPP


////////////////////////////////////////////////////////////
/// \class sfmljoy::NonCopyable
/// \ingroup system
///
...
/// in sfmljoy::NonCopyable so they will end up being inaccessible in both
/// cases. Thus you can use a shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
/// class MyNonCopyableClass : sfmljoy::NonCopyable
/// {
///     ...
/// };
/// \endcode
...
/// and to use sfmljoy::NonCopyable when necessary to prevent
