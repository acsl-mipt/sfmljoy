...
#ifndef SFMLJOY_UTF_HPP
#define SFMLJOY_UTF_HPP
...
public:
    ...
    /// specializations of the sfmljoy::Utf<> template, and allow
...
public:
    ...
    /// of sfmljoy::Utf<>, it is defined for convenience (it is used by
...
///
/// sfmljoy::Utf is a low-level, generic interface for counting, iterating,
...
///
/// sfmljoy::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li sfmljoy::Utf<8> (typedef'd to sfmljoy::Utf8)
/// \li sfmljoy::Utf<16> (typedef'd to sfmljoy::Utf16)
/// \li sfmljoy::Utf<32> (typedef'd to sfmljoy::Utf32)
///
////////////////////////////////////////////////////////////
